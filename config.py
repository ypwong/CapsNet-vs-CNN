...
parser.add_argument('--mode', type=str, default=None, help='Specify the mode of the training. None of transfer_learning.')
...
parser.add_argument('--train_num_data_per_class', type=int, help='Specify the number of data to be generated per class for training.')
parser.add_argument('--test_num_data_per_class', type=int, help='Specify the number of data to be generated per class for testing.')
parser.add_argument('--load_from_disk', type=bool, help='Setting to True would load the dataset from disk. Else dataset will be generated and written to disk.')
parser.add_argument('--data_path', type=str, help='Specify the path to the dataset folder to write to or load from.')
